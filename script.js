...
const diseaseData = {
    "出席停止対象感染症": {
        "麻しん（はしか）": { text: "解熱後3日を経過していること", days: null, characteristics: "38度以上の発熱、咳・鼻水、目の充血などに続き、口内の白い斑点や全身の赤い発疹が出現します。感染力が非常に強く、空気感染します。" },
        ...
        "咽頭結膜熱（プール熱）（アデノウイルス）": { text: "発熱、充血等の主な症状が消失した後2日経過していること", days: null, characteristics: "発熱、のどの痛み、目の充血（結膜炎）が主な症状です。夏にプールなどを介して流行することがあります。" },
    ...
    "注意すべき感染症": {
        "溶連菌感染症": { text: "抗菌薬服用後24～48時間経過していること", days: null, characteristics: "突然の発熱、のどの強い痛み、舌がイチゴのように赤くなる（イチゴ舌）、全身の細かい発疹が特徴です。" },
